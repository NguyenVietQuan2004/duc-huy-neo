...
import Slider from "@/app/(trangchu)/_components/carousel";
...
import { productsOne, productsThree, productsTwo, sort } from "@/app/(trangchu)/_components/data";
import { notFound, useParams, useSearchParams } from "next/navigation";
import { categories, categoriesProduct, products as Json } from "../../(trangchu)/_components/data-new";
...
function Category() {
    ...
    return (
      <div className="max-w-[1240px] px-5 mx-auto py-12">
        <div className="flex items-center gap-2 text-[12px]">
          Nhà <ChevronRight size={14} /> <span className="text-[#999999]">RESILIENCE/VITALITY</span>
        </div>
        <div className="py-10 grid grid-cols-5 gap-6">
          ...
          <div className="col-span-4 border-t">
            ...
            <div className="text-center">
              <div className="text-sm italic text-zinc-500">0 sản phẩm</div>
              <b>
  ...
  return (
    <div className="max-w-[1240px] px-0 lg:px-5 mx-auto py-0 lg:py-12">
      ...
      <div className="mb-10">
        <h2 className="text-[20px] text-center lg:text-start lg:text-2xl my-4 font-bold">Sản phẩm nổi bậc</h2>
