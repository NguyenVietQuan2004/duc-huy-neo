...
//                 <Image alt="" fill src={item.image} className="h-[100vh] lg:h-auto xl:w-[100vw] object-cover" />
//                 <div
                ...
                >
                  ...
                  <h2
                    ...
                    dangerouslySetInnerHTML={{
                      __html: t(item.text1Key),
                    }}
                  />

                  {/* TEXT 2 */}
                  {item.text2Key && <div className="text-[18px] mt-2 mb-7 font-normal">{t(item.text2Key)}</div>}
