...
// import { categoriesProduct } from "./data-new";
...
//         <h2 className="text-3xl text-center mb-12">{t("DacTrung.title")}</h2>
...
//                 <div className="text-center text-xl">{t(item.labelKey)}</div>
//               </div>
//             );
//           })}
//         </div>
...
//             {t("DacTrung.watertrainLine1")}
//             <br />
//             {t("DacTrung.watertrainLine2")}
//           </h2>
...
//         <div className="flex justify-center items-center flex-col">
//           <h2 className="text-[31px] leading-[31px] font-semibold text-center mb-4">
//             {t("DacTrung.faucetLine1")}
//             <br />
//             {t("DacTrung.faucetLine2")}
//           </h2>
...
//       >
//         <h2 className="text-3xl text-center mb-12">{t("DacTrung.exploreTitle")}</h2>

//         <div className="flex justify-center">
//           <Image
//             alt=""
//             src="https://images.ctfassets.net/m9mcybwguwgq/tmtlARv9voka6fgaPIp8z/3a38574f5851eb9087acce2d4d3d602e/NeoperlAboutUs-Stage.jpg?w=640&q=95&fm=webp"
//             width={1000}
//             height={1000}
