...
//               Do you have a question or a comment? Do you want to know more about Neoperl and our products? (33)
//             </div>
//           </div>
//         </div>
//       </div>
...
//               <p>Địa chỉ: 46F đường Nam Cao, Khu phố 8, phường Tăng Nhơn Phú, Tp. Hồ Chí Minh, Việt Nam.</p> (34)
//               {/* Google Map */}
//               <iframe
...
//                 <span className="font-semibold">SĐT liên hệ (35):</span> {phone}
//               </div>
//             </div>
//           </div>
...
function ContactClient() {
  const t = useTranslations("ContactClient");
  ...
  return (
    <div>
      ...
      <div className="relative h-[500px]">
        ...
        <div className="relative max-w-[1140px] py-[120px] h-full pt-[160px] lg:pt-[120px] mx-auto px-4">
          <div className="text-white max-w-[540px]">
            <div className="text-[18px]">{t("contact")}</div>
            <div className="text-[18px] lg:text-[36px] font-bold">{t("bannerTitle")}</div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <div className="mt-4 text-base">
                <span className="font-semibold">{t("phoneLabel")}</span> {phone}
              </div>
            </div>
          </div>
